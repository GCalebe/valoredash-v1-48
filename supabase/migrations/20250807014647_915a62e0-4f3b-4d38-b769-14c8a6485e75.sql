-- Add missing fields to calendar_events table for better data structure
...
-- Create employees table if it doesn't exist (for proper FK relationship)
...
-- Create products table if it doesn't exist (for proper FK relationship)
...
-- Insert some default employees and products for existing users
INSERT INTO employees (name, user_id)
SELECT DISTINCT host_name, user_id 
