  ...
  useEffect(() => {
    if (personalityData && personalityData.length > 0) {
      ...
      setSettings({
        ...
        personality: data.personality_type || "Sou um assistente virtual dedicado a ajudar você da melhor forma possível.",
        formality: data.temperature || 3,
        empathy: 4,
        creativity: 3,
        directness: 3,
        greeting: data.greeting_message || "Olá! Como posso ajudá-lo hoje?",
        farewell: "Foi um prazer ajudá-lo! Tenha um ótimo dia!",
        specialInstructions: data.custom_instructions || "Sempre seja cordial e tente resolver o problema do cliente.",
        maxResponses: data.max_tokens || 3,
        messageSize: 3,
        responseTime: 3,
        audioResponse: false,
        responseCreativity: 3,
