  ...
  public: {
    Tables: {
      agenda_available_dates: {
        ...
        Relationships: [
          {
            foreignKeyName: "agenda_available_dates_agenda_id_fkey"
            columns: ["agenda_id"]
            isOneToOne: false
      ...
      agenda_operating_hours: {
        ...
        Relationships: [
          {
            foreignKeyName: "agenda_operating_hours_agenda_id_fkey"
            columns: ["agenda_id"]
            isOneToOne: false
            referencedRelation: "agendas"
            referencedColumns: ["id"]
      ...
      agenda_reminders: {
        ...
        Relationships: [
          {
            foreignKeyName: "agenda_reminders_agenda_id_fkey"
            columns: ["agenda_id"]
            isOneToOne: false
            referencedRelation: "agendas"
            referencedColumns: ["id"]
      ...
      client_product_purchases: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_client_product_purchases_product"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
      ...
      client_products_interest: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_client_products_interest_product"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
      ...
      employee_agendas: {
        ...
        Relationships: [
          {
            foreignKeyName: "employee_agendas_agenda_id_fkey"
            columns: ["agenda_id"]
            isOneToOne: false
            referencedRelation: "agendas"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "employee_agendas_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["id"]
      ...
      knowledge_analytics: {
        ...
        Relationships: [
          {
            foreignKeyName: "knowledge_analytics_article_id_fkey"
            columns: ["article_id"]
            isOneToOne: false
      ...
      knowledge_ratings: {
        ...
        Relationships: [
          {
            foreignKeyName: "knowledge_ratings_article_id_fkey"
            columns: ["article_id"]
            isOneToOne: false
            referencedRelation: "knowledge_base"
            referencedColumns: ["id"]
